...
A collection of interactive data visualization dashboards created in Tableau, showcasing various analytical techniques including time series analysis, geographic mapping, Gantt charts, and performance tracking.
...
**Key Insight:** The nadir occurred in April-May 2020 with over 83 million fewer passengers per month.
...
**Key Insight:** Rapid adoption curve reaching 1.60B monthly visits by January 2024.
...
**Key Insight:** Enables cross-functional visibility between campaign execution, experimental testing, and communication cadence.
...
**Key Insight:** Significant digital divide with 17x speed differential between fastest and slowest regions.
...
**Key Insight:** Hierarchical view of connectivity inequality across the continent.
...
**Key Insight:** Quality remained high through season 5, with notable decline in seasons 8-9.
...
|-----------|-----------|
| Time Series Analysis | Air Passengers, ChatGPT Traffic, Sales Performance |
| Geographic Mapping | Africa Internet Speed |
| Gantt Charts | CRM Timeline |
| Heatmaps | Friends Ratings |
| Interactive Filtering | Compensation Tool |
| Variance Analysis | Elf Efficiency |
| Waterfall/Bar Charts | COVID Effects |


## 🚀 Getting Started

1. **View Online:** Download `.twbx` files or open with [Tableau Public](https://public.tableau.com/app/profile/samuel.jinadu)
2. **Explore:** Each workbook contains interactive filters, tooltips, and drill-down capabilities
3. **Data Sources:** Attribution included in each dashboard footer (Bureau of Transportation Statistics, data.world, Kaggle, etc.)

## 👤 About the Author

[**Jinadu Samuel**](https://public.tableau.com/app/profile/samuel.jinadu) 
Data Visualization Designer creating interactive analytics solutions for business intelligence, operational tracking, and storytelling.

---

*Created as part of #WorkoutWednesday and #WOW2024 challenges, plus independent analytical projects.*
